...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <div id="app">
						...
						<div class="col-md-3 col-sm-4">
							<div class="single-new-arrival">
								<div class="single-new-arrival-bg">
									<img src="images/collection/{{ $product->image_name}}" alt="new-arrivals images">
								...
								{{ $product->description }}
								<p class="arrival-product-price">${{ $product->sale_price}} <del><sup>${{ $product->price}}</sup></del></p>
		...
		<script src="jst/jquery.js"></script>
		...
		<!-- bootsnav js -->
		<script src="jst/bootsnav.js"></script>
